...
const SingleBlog = () => {
  ...
  const desc =
    "An online shop is a digital platform that allows customers to browse, select, and purchase products or services from the comfort of their home. Unlike traditional brick-and-mortar stores, online shops offer the convenience of 24/7 accessibility, diverse payment options, and global reach. These platforms typically feature detailed product descriptions, high-quality images, and customer reviews to enhance the shopping experience. With secure payment systems and fast shipping options, online shops cater to the needs of modern consumers looking for efficiency and variety. Whether it's fashion, electronics, or groceries, online shops provide a seamless and personalized way to shop.";
  const desc2 =
    "There is only one boss. The customer. And he can fire everybody in the company from the chairman on down, simply by spending his money somewhere else.";
  const desc3 =
    "Online shopping has revolutionized the way people purchase goods and services, offering unparalleled convenience and accessibility. With just a few clicks, consumers can browse a vast selection of products, compare prices, read reviews, and make purchases from the comfort of their homes. This digital marketplace operates 24/7, eliminating the constraints of traditional store hours and geographical limitations. ";
  const desc4 =
                            ...
                            <div key={item.id}>
                              ...
                              <div className="post-content">
                                ...
                                <div className="video-thumb">
                                  ...
                                  />
                                  <a
                                    href="https://youtu.be/PGuKjkdGrEI?si=lF0CJJ6khm6Nx46O"
                      ...
                      <div className="navigations-part">
                        <div className="left">
                          ...
                          <a href="#" className="title">
                            Evisculate parralel processes via Technical sound
                            Model Authoritative
                          </a>
                        </div>
                        <div className="right">
